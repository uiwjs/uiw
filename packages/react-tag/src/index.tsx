...
export default (props: TagProps = {}) => {
  const { prefixCls = 'w-tag', className, style, title = '', children, visible = true, color = '#6E6E6E', disabled = false, bordered = true, closable, light = false, onClose, ...other } = props;
  ...
  const closeBtn = useMemo(() => closable ? (
