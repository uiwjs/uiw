...
render() {
  return (
    <div>
        ...
        <Button type="primary"> （首选项）Primary </Button>
        <Button type="success"> （成功）Success </Button>
        <Button type="info"> （一般信息）Info </Button>
        <Button type="warn"> （警告）Warning </Button>
        <Button type="danger"> （危险）Danger </Button>
