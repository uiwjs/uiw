      ...
      return (
        <div>
          ...
          <div className={`${prefixCls}-docinfo`}>
            犯了错误还是想对文件做出贡献？ <a href={`https://github.com/uiw-react/uiw/blob/v1/docs/md/${this.getLang() + '/' + this.getPageName()}.md`} target="_blank" rel="noopener noreferrer">在Github上编辑本页！</a> <br />
