...
var Modal = function (_Component) {
  ...
  Modal.prototype.render = function render() {
    ...
    switch (horizontal) {
      case 'left':
        AnimateType = 'fade-left';break;
      case 'right':
        AnimateType = 'fade-right';break;
      default:
        AnimateType = 'fade-down';break;
    }
    ...
    return React.createElement(
      ...
      React.createElement(
        Transition,
        { type: 'fade-in' },
        leave && React.createElement('div', { className: prefixCls + '-mask', style: styleMask, onClick: function onClick() {
