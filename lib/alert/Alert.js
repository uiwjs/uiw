...
var Alert = function (_Component) {
  ...
  Alert.prototype.render = function render() {
    ...
    if (showIcon) {
      switch (type) {
        case "success":
          icon = React.createElement(Icon, { type: 'circle-check-o' });break;
        case "info":
          icon = React.createElement(Icon, { type: 'information-o' });break;
        case "warning":
          icon = React.createElement(Icon, { type: 'question-circle-o' });break;
        case "error":
          icon = React.createElement(Icon, { type: 'circle-close-o' });break;
        default:
          break;
      }
    }
    ...
    var alertsview = !this.state.visible ? null : React.createElement(
      'div',
    ...
    return React.createElement(
      Transition,
      { visible: this.state.tranVisible, type: transition },
      alertsview
    );
  };
