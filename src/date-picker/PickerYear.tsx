...
export interface IPickerYearProps extends IProps, HTMLDivProps {
  panelDate?: Date;
  panelNum?: number[];
...
export default class PickerYear extends React.Component<IPickerYearProps, IPickerYearState> {
